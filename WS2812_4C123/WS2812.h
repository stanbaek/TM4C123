...
//#define NUMCOLS 36  // number of LEDs per string (NOTE: See line 327 of WS2812.c in WS2812_PrintBuffer() where this is also hard-coded)
//#define NUMCOLS 96  // number of LEDs per string
